...
ssize_t __cdecl readNoInt(int fd, void* buf, size_t n);
ssize_t __cdecl preadNoInt(int fd, void* buf, size_t n, off_t offset);
ssize_t __cdecl readvNoInt(int fd, const iovec* iov, int count);

ssize_t __cdecl writeNoInt(int fd, const void* buf, size_t n);
ssize_t __cdecl pwriteNoInt(int fd, const void* buf, size_t n, off_t offset);
 ...
 * is unspecified.
 */
FOLLY_NODISCARD ssize_t __cdecl readFull(int fd, void* buf, size_t n);
FOLLY_NODISCARD ssize_t __cdecl preadFull(int fd, void* buf, size_t n, off_t offset);
 ...
 */
ssize_t __cdecl writeFull(int fd, const void* buf, size_t n);
ssize_t __cdecl pwriteFull(int fd, const void* buf, size_t n, off_t offset);
